...
-- local wvRect = rect(10, 10, 200, 800)

function mod.makeWebview ()
  local wv = webview.new(geometry.rect(10, 10, 400, 800))
  wv:url('https://twitter.com/jsscclr')
  wv:windowStyle({
    "closable",
    "titled",
  })
  -- wv:windowStyle(webview.windowMasks)
...
function mod.init()
    omh.bind(mod.config.open_wv_key, mod.makeWebview)
